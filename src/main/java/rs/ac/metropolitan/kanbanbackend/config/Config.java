package rs.ac.metropolitan.kanbanbackend.config;
...
@EnableJpaRepositories(basePackages = {"rs.ac.metropolitan.kanbanbackend.repository"},
...
public class Config {
        ...
        public LocalContainerEntityManagerFactoryBean customEntityManager() {
                ...
                em.setPackagesToScan("rs.ac.metropolitan.kanbanbackend.entity");
